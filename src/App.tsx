      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              <div className="text-3xl lg:text-4xl font-bold text-green-500 mb-2">92%</div>
              <p className="text-muted-foreground">Accuracy in Candidate Matching</p>
            </div>
            <div>
              <div className="text-3xl lg:text-4xl font-bold text-purple-500 mb-2">3x</div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-card p-8 rounded-xl shadow-sm border border-border hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Custom Criteria Matching</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-card p-8 rounded-xl shadow-sm border border-border hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Bias-Free Screening</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-card p-8 rounded-xl shadow-sm border border-border hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Instant Processing</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-card p-8 rounded-xl shadow-sm border border-border hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Smart Insights</h3>
              <p className="text-muted-foreground">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-foreground mb-4">Upload Applications</h3>
              <p className="text-muted-foreground">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-card p-6 rounded-lg shadow-sm border border-border">
              ...
              <p className="font-semibold text-foreground">Sarah Chen, CTO at TechFlow</p>
            </div>
            <div className="bg-card p-6 rounded-lg shadow-sm border border-border">
              <div className="flex items-center mb-4">
                {[...Array(5)].map((_, i) => (
              ...
              <p className="font-semibold text-foreground">Mike Rodriguez, Lead Developer</p>
            </div>
            <div className="bg-card p-6 rounded-lg shadow-sm border border-border">
              <div className="flex items-center mb-4">
                {[...Array(5)].map((_, i) => (
              ...
              <p className="font-semibold text-foreground">Lisa Park, HR Director</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-card p-8 rounded-xl border border-border">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  ...
                  <span className="text-muted-foreground">Up to 50 applications/month</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                  <span className="text-muted-foreground">Basic AI filtering</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
            ...
            <div className="bg-card p-8 rounded-xl border-2 border-primary relative">
              ...
              <div className="text-3xl font-bold text-foreground mb-2">$49<span className="text-lg text-muted-foreground">/month</span></div>
              <p className="text-muted-foreground mb-6">For growing companies</p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                  <span className="text-muted-foreground">Up to 500 applications/month</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                  <span className="text-muted-foreground">Advanced AI + custom criteria</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
            ...
            <div className="bg-card p-8 rounded-xl border border-border">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                  <span className="text-muted-foreground">Unlimited applications</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
